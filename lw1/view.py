...
class MainWindow(QMainWindow):
    ...
    def show_help(self):
        QMessageBox.information(self, "Помощь",
            "Программа анализа текста PDF документа.\n\n"
            "Для открытия документа для анализа нажмите \"Открыть PDF\" и выберете файл\n"
            "Кнопка \"Загрузить проект\" восстанавливает данные из .json\n"
            "Кнопка \"Сохранить результат\" сохраняет данные в .json\n"
            "Комментарии сохраняются автоматически при нажатии 'Сохранить'.")
    ...
    def update_table(self, data, comments=None):
        ...
        for lexeme in sorted_lexemes:
            ...
            sorted_wf = sorted(word_forms.items())
